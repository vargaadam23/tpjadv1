    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "org.tpjad");
                servletContext.setInitParameter("tapestry.development-modules", "org.tpjad.services.DevelopmentModule");
